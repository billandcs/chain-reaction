...
- `[x]` CR-032 Token Flow Page: tokens page, create-from-address flow, local token detail, market token detail, side-by-side price/flow analysis, holders, and transfer rows are implemented.
...
- CoinGecko token logos with polished fallback avatars.
